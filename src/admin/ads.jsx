    ...
    <Container>
      <Row className='fullWidth m_t_50 justify-content-center'>
            ...
            <Table >
              <TableHead >
                <TableRow>
                  ...
                  <TableCell align="start"> text </TableCell>
        ...
        <Col className="dash_component" lg={4} md={3} sm={12} >
          ...
          <div className="p_10">
            <label> Add text on image </label>
            <TextField multiline minRows={3} fullWidth id="outlined-basic" label="name" variant="outlined" />
          </div>
        </Col>
      </Row>
    </Container>
